            ...
            <Item className="mc-notify-item" key={index}>
              <Anchor className="mc-notify-content" href={item.path}>
                <Box className="mc-notify-media">
                  ...
                  <Icon className={`material-icons ${item.icon.variant}`}>
                    {item.icon.label}
                  </Icon>
                </Box>
                <Box className="mc-notify-meta">
                  <Text as="span">
                    <Text as="b">{item.note.user}</Text> {item.note.text}{" "}
                    <Text as="b">{item.note.reason}</Text>
                  </Text>
                  <Text as="small">{item.time}</Text>
                </Box>
              </Anchor>
              <Button className="mc-notify-close">
