  ...
  return (
    <Box className="mc-overview">
      ...
      <Section className="mc-overview-demo">
        <Container fluid>
          <Heading as="h2" className="mc-overview-title">
            unique pages
          </Heading>
          <Row xs={1} sm={2} xl={3}>
      ...
      <Section className="mc-overview-footer">
        <Heading as="h2">
          Do you want to inquiry about iemzone template?
        </Heading>
        <a
          href="https://themeforest.net/item/iemzone-react-admin-dashboard-template/40188968/support"
          target="_blank"
          rel="noopener noreferrer"
          className="mc-btn primary"
        >
        ...
        <Text>
          Iemzone | © Copyrights by <Text as="span">Mironcoder</Text>
        </Text>
      </Section>
    </Box>
  );
